...
def get_dashboard_context(user, portfolio_id=None):
    ...
    # Pobieramy 10 ostatnich transakcji do tabeli
    ...
    context = {
        ...
        # Ostatnie transakcje (Cashflow log)
...
def get_asset_details_context(user, symbol, portfolio_id=None):
    ...
    for t in asset_data['trades']:
        ...
        elif t['type'] in ['CLOSE SELL', 'SELL', 'CLOSE']:  # Dodano CLOSE
    ...
    return {
        ...
        # --- FIX: POPRAWIONA NAZWA ZMIENNEJ (first_date zamiast first_trade_date) ---
