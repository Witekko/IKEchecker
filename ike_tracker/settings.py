...
INSTALLED_APPS = [
    ...
    'django.contrib.sites',  # Wymagane przez django-allauth
    'core',
...
MIDDLEWARE = [
    ...
    'allauth.account.middleware.AccountMiddleware',  # Wymagane przez django-allauth
]
...
# --- ALLAUTH & SSO GOOGLE AUTHENTICATION ---
SITE_ID = 1
...
# --- SECURITY HARDENING (ALL ENVIRONMENTS) ---
